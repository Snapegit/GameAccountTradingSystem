	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="会员价" prop="vipprice">
					<el-input v-model="ruleForm.vipprice" placeholder="会员价" clearable  :readonly="ro.vipprice"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="会员价" prop="vipprice">
